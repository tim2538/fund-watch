...
const en: Dict = {
  ...
  txExport: "Export",
  txImport: "Import",
  txImportResult: "Imported {added} new, skipped {skipped} duplicate(s).",
  txImportEmpty: "No valid transactions found in the file.",
  txImportError: "Couldn't read the file. Use a CSV exported from Fund Watch.",
...
const th: Dict = {
  ...
  txExport: "ส่งออก",
  txImport: "นำเข้า",
  txImportResult: "นำเข้าใหม่ {added} รายการ ข้ามรายการซ้ำ {skipped} รายการ",
  txImportEmpty: "ไม่พบรายการที่ถูกต้องในไฟล์",
  txImportError: "อ่านไฟล์ไม่สำเร็จ ใช้ไฟล์ CSV ที่ส่งออกจาก Fund Watch",
  txDelete: "ลบรายการ",
